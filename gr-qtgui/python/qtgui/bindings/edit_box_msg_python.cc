...
void bind_edit_box_msg(py::module& m)
{
    ...
    py::class_<edit_box_msg, gr::block, gr::basic_block,
        std::shared_ptr<edit_box_msg>>(m, "edit_box_msg", D(edit_box_msg))
        ...
        .def("exec_",&edit_box_msg::exec_,
            D(edit_box_msg,exec_)
        )


        .def("qwidget",&edit_box_msg::qwidget,
