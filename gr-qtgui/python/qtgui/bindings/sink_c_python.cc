...
void bind_sink_c(py::module& m)
{
    ...
    py::class_<sink_c, gr::block, gr::basic_block,
        std::shared_ptr<sink_c>>(m, "sink_c", D(sink_c))
        ...
        .def("exec_",&sink_c::exec_,
            D(sink_c,exec_)
        )


        .def("qwidget",&sink_c::qwidget,
            D(sink_c,qwidget)
        )
        ...
        .def("set_fft_size",&sink_c::set_fft_size,
            py::arg("fftsize"),
            D(sink_c,set_fft_size)
        )


        .def("fft_size",&sink_c::fft_size,
            D(sink_c,fft_size)
        )
        ...
        .def("set_fft_power_db",&sink_c::set_fft_power_db,
            py::arg("min"),
            py::arg("max"),
        ...
        .def("enable_rf_freq",&sink_c::enable_rf_freq,
            py::arg("en"),
            D(sink_c,enable_rf_freq)
        )


        .def("set_update_time",&sink_c::set_update_time,
            py::arg("t"),
