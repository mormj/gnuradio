...
void bind_selective_fading_model2(py::module& m)
{
    ...
    py::class_<selective_fading_model2, gr::sync_block, gr::block, gr::basic_block,
        std::shared_ptr<selective_fading_model2>>(m, "selective_fading_model2", D(selective_fading_model2))
        ...
        .def("fDTs",&selective_fading_model2::fDTs,
            D(selective_fading_model2,fDTs)
        )


        .def("K",&selective_fading_model2::K,
            D(selective_fading_model2,K)
        )


        .def("step",&selective_fading_model2::step,
            D(selective_fading_model2,step)
        )
