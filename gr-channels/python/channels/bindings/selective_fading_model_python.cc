...
void bind_selective_fading_model(py::module& m)
{
    ...
    py::class_<selective_fading_model, gr::sync_block, gr::block, gr::basic_block,
        std::shared_ptr<selective_fading_model>>(m, "selective_fading_model", D(selective_fading_model))
        ...
        .def("fDTs",&selective_fading_model::fDTs,
            D(selective_fading_model,fDTs)
        )


        .def("K",&selective_fading_model::K,
            D(selective_fading_model,K)
        )


        .def("step",&selective_fading_model::step,
            D(selective_fading_model,step)
        )
