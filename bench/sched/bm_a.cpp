...
int main(int argc, char* argv[])
{
    ...
    app.add_option("--buffer_size", stages, "Default Buffer Size");
...

    {
        ...
        std::vector<gr::bench::copy::sptr> copy_blks(stages*3);
        ...
        if (nthreads == 1) {
            ...
            sched->add_block_group(block_group, "group" + std::to_string(i));
        }
