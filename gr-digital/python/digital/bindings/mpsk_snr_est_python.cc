...
void bind_mpsk_snr_est(py::module& m)
{
    ...
    py::class_<mpsk_snr_est,
        std::shared_ptr<mpsk_snr_est>>(m, "mpsk_snr_est", D(mpsk_snr_est))

        .def(py::init<double>(),           py::arg("alpha"),
           D(mpsk_snr_est,mpsk_snr_est,0)
        )
        ...
        .def("signal",&mpsk_snr_est::signal,
            D(mpsk_snr_est,signal)
        )


        .def("noise",&mpsk_snr_est::noise,
            D(mpsk_snr_est,noise)
        )
    ...
    py::class_<mpsk_snr_est_simple, gr::digital::mpsk_snr_est,
        std::shared_ptr<mpsk_snr_est_simple>>(m, "mpsk_snr_est_simple", D(mpsk_snr_est_simple))
    ...
    py::class_<mpsk_snr_est_skew, gr::digital::mpsk_snr_est,
        std::shared_ptr<mpsk_snr_est_skew>>(m, "mpsk_snr_est_skew", D(mpsk_snr_est_skew))
    ...
    py::class_<mpsk_snr_est_m2m4, gr::digital::mpsk_snr_est,
        std::shared_ptr<mpsk_snr_est_m2m4>>(m, "mpsk_snr_est_m2m4", D(mpsk_snr_est_m2m4))
    ...
    py::class_<snr_est_m2m4, gr::digital::mpsk_snr_est,
        std::shared_ptr<snr_est_m2m4>>(m, "snr_est_m2m4", D(snr_est_m2m4))
    ...
    py::class_<mpsk_snr_est_svr, gr::digital::mpsk_snr_est,
        std::shared_ptr<mpsk_snr_est_svr>>(m, "mpsk_snr_est_svr", D(mpsk_snr_est_svr))
