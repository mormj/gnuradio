...
void bind_pfb_clock_sync_ccf(py::module& m)
{
    ...
    py::class_<pfb_clock_sync_ccf, gr::block, gr::basic_block,
        std::shared_ptr<pfb_clock_sync_ccf>>(m, "pfb_clock_sync_ccf", D(pfb_clock_sync_ccf))
        ...
        .def("taps",&pfb_clock_sync_ccf::taps,
            D(pfb_clock_sync_ccf,taps)
        )


        .def("diff_taps",&pfb_clock_sync_ccf::diff_taps,
            D(pfb_clock_sync_ccf,diff_taps)
        )
        ...
        .def("alpha",&pfb_clock_sync_ccf::alpha,
            D(pfb_clock_sync_ccf,alpha)
        )


        .def("beta",&pfb_clock_sync_ccf::beta,
            D(pfb_clock_sync_ccf,beta)
        )
        ...
        .def("error",&pfb_clock_sync_ccf::error,
            D(pfb_clock_sync_ccf,error)
        )


        .def("rate",&pfb_clock_sync_ccf::rate,
            D(pfb_clock_sync_ccf,rate)
        )


        .def("phase",&pfb_clock_sync_ccf::phase,
            D(pfb_clock_sync_ccf,phase)
        )
