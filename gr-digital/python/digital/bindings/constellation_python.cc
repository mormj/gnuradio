...
void bind_constellation(py::module& m)
{
    ...
    py::class_<constellation, std::enable_shared_from_this<gr::digital::constellation>,
        ...
        .def("map_to_points",&constellation::map_to_points,
            py::arg("value"),
            py::arg("points"),
        ...
        .def("map_to_points_v",&constellation::map_to_points_v,
            py::arg("value"),
            D(constellation,map_to_points_v)
        )


        .def("decision_maker",&constellation::decision_maker,
            py::arg("sample"),
            D(constellation,decision_maker)
        )


        .def("decision_maker_v",&constellation::decision_maker_v,
            py::arg("sample"),
            D(constellation,decision_maker_v)
        )


        .def("decision_maker_pe",&constellation::decision_maker_pe,
            py::arg("sample"),
            py::arg("phase_error"),
        ...
        .def("calc_metric",&constellation::calc_metric,
            py::arg("sample"),
            py::arg("metric"),
            py::arg("type"),
        ...
        .def("calc_euclidean_metric",&constellation::calc_euclidean_metric,
            py::arg("sample"),
            py::arg("metric"),
        ...
        .def("points",&constellation::points,
            D(constellation,points)
        )


        .def("s_points",&constellation::s_points,
            D(constellation,s_points)
        )


        .def("v_points",&constellation::v_points,
            D(constellation,v_points)
        )
        ...
        .def("set_pre_diff_code",&constellation::set_pre_diff_code,
            py::arg("a"),
        ...
        .def("arity",&constellation::arity,
            D(constellation,arity)
        )


        .def("base",&constellation::base,
            D(constellation,base)
        )


        .def("as_pmt",&constellation::as_pmt,
            D(constellation,as_pmt)
        )


        .def("gen_soft_dec_lut",&constellation::gen_soft_dec_lut,
            py::arg("precision"),
            py::arg("npwr") = 1.,
        ...
        .def("calc_soft_dec",&constellation::calc_soft_dec,
            py::arg("sample"),
            py::arg("npwr") = 1.,
        ...
        .def("set_soft_dec_lut",&constellation::set_soft_dec_lut,
            py::arg("soft_dec_lut"),
            py::arg("precision"),
        ...
        .def("soft_dec_lut",&constellation::soft_dec_lut,
            D(constellation,soft_dec_lut)
        )


        .def("soft_decision_maker",&constellation::soft_decision_maker,
            py::arg("sample"),
    ...
    py::class_<constellation_calcdist, gr::digital::constellation,
        std::shared_ptr<constellation_calcdist>>(m, "constellation_calcdist", D(constellation_calcdist))
        ...
        .def("decision_maker",&constellation_calcdist::decision_maker,
            py::arg("sample"),
    ...
    py::class_<constellation_sector, gr::digital::constellation,
        std::shared_ptr<constellation_sector>>(m, "constellation_sector", D(constellation_sector))

        // .def(py::init<std::vector<std::complex<float>, std::allocator<std::complex<float> > >,std::vector<int, std::allocator<int> >,unsigned int,unsigned int,unsigned int>(),           py::arg("constell"),
        //    py::arg("pre_diff_code"),
        //    py::arg("rotational_symmetry"),
        //    py::arg("dimensionality"),
        //    py::arg("n_sectors"),
        ...
        .def("decision_maker",&constellation_sector::decision_maker,
            py::arg("sample"),
    ...
    py::class_<constellation_rect, gr::digital::constellation_sector,
        std::shared_ptr<constellation_rect>>(m, "constellation_rect", D(constellation_rect))
    ...
    py::class_<constellation_expl_rect, gr::digital::constellation_rect,
        std::shared_ptr<constellation_expl_rect>>(m, "constellation_expl_rect", D(constellation_expl_rect))
    ...
    py::class_<constellation_psk, gr::digital::constellation_sector,
        std::shared_ptr<constellation_psk>>(m, "constellation_psk", D(constellation_psk))
    ...
    py::class_<constellation_bpsk, gr::digital::constellation,
        ...
        .def("decision_maker",&constellation_bpsk::decision_maker,
            py::arg("sample"),
    ...
    py::class_<constellation_qpsk, gr::digital::constellation,
        ...
        .def("decision_maker",&constellation_qpsk::decision_maker,
            py::arg("sample"),
    ...
    py::class_<constellation_dqpsk, gr::digital::constellation,
        std::shared_ptr<constellation_dqpsk>>(m, "constellation_dqpsk", D(constellation_dqpsk))

        .def(py::init(&constellation_dqpsk::make),
           D(constellation_dqpsk,make)
        )
        ...
        .def("decision_maker",&constellation_dqpsk::decision_maker,
            py::arg("sample"),
    ...
    py::class_<constellation_8psk, gr::digital::constellation,
        std::shared_ptr<constellation_8psk>>(m, "constellation_8psk", D(constellation_8psk))

        .def(py::init(&constellation_8psk::make),
           D(constellation_8psk,make)
        )
        ...
        .def("decision_maker",&constellation_8psk::decision_maker,
            py::arg("sample"),
    ...
    py::class_<constellation_8psk_natural, gr::digital::constellation,
        std::shared_ptr<constellation_8psk_natural>>(m, "constellation_8psk_natural", D(constellation_8psk_natural))
        ...
        .def("decision_maker",&constellation_8psk_natural::decision_maker,
            py::arg("sample"),
    ...
    py::class_<constellation_16qam, gr::digital::constellation,
        ...
        .def("decision_maker",&constellation_16qam::decision_maker,
            py::arg("sample"),
