...
void bind_clock_recovery_mm_ff(py::module& m)
{
    ...
    py::class_<clock_recovery_mm_ff, gr::block, gr::basic_block,
        std::shared_ptr<clock_recovery_mm_ff>>(m, "clock_recovery_mm_ff", D(clock_recovery_mm_ff))
        ...
        .def("mu",&clock_recovery_mm_ff::mu,
            D(clock_recovery_mm_ff,mu)
        )


        .def("omega",&clock_recovery_mm_ff::omega,
            D(clock_recovery_mm_ff,omega)
        )
