...
void bind_additive_scrambler_bb(py::module& m)
{
    ...
    py::class_<additive_scrambler_bb, gr::sync_block, gr::block, gr::basic_block,
        std::shared_ptr<additive_scrambler_bb>>(m, "additive_scrambler_bb", D(additive_scrambler_bb))
        ...
        .def("mask",&additive_scrambler_bb::mask,
            D(additive_scrambler_bb,mask)
        )


        .def("seed",&additive_scrambler_bb::seed,
            D(additive_scrambler_bb,seed)
        )


        .def("len",&additive_scrambler_bb::len,
            D(additive_scrambler_bb,len)
        )


        .def("count",&additive_scrambler_bb::count,
            D(additive_scrambler_bb,count)
        )
