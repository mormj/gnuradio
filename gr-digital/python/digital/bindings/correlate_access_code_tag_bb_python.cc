...
void bind_correlate_access_code_tag_bb(py::module& m)
{
    ...
    py::class_<correlate_access_code_tag_bb, gr::sync_block, gr::block, gr::basic_block,
        std::shared_ptr<correlate_access_code_tag_bb>>(m, "correlate_access_code_tag_bb", D(correlate_access_code_tag_bb))
