...
#ifndef INCLUDED_GR_ANALOG_SIG_SOURCE_PYTHON_HPP
#define INCLUDED_GR_ANALOG_SIG_SOURCE_PYTHON_HPP
...
void bind_sig_source_template(py::module& m, const char* classname)
{
    ...
    py::class_<sig_source, gr::sync_block, std::shared_ptr<sig_source>>(m, classname)
        ...
        .def("set_sampling_freq", &sig_source::set_sampling_freq, py::arg("sampling_freq"))
...
#endif /* INCLUDED_GR_ANALOG_SIG_SOURCE_PYTHON_HPP */
