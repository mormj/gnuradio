...
if(DEFINED __INCLUDED_GR_PYDOC_CMAKE)
    return()
endif()
set(__INCLUDED_GR_PYDOC_CMAKE TRUE)

include(GrPython)

########################################################################
# Modifies pybind generated headers to be contain Doxygen python docstrings
# Usage: GR_MAKE_DOCSTRINGS(output_file input_path input_path....)
#
# Set the following variable to specify extra dependent targets:
#   - GR_SWIG_DOCS_SOURCE_DEPS
#   - GR_SWIG_DOCS_TARGET_DEPS
########################################################################
function(GR_MAKE_DOCSTRINGS output_file)
    if(ENABLE_DOXYGEN)
...
endfunction(GR_MAKE_DOCSTRINGS)
...
macro(GR_SWIG_MAKE name)
    ...
    if(GR_SWIG_DOC_FILE)
        ...
        GR_MAKE_DOCSTRINGS(${GR_SWIG_DOC_FILE} ${GR_SWIG_DOC_DIRS})
