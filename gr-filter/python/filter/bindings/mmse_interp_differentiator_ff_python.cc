...
void bind_mmse_interp_differentiator_ff(py::module& m)
{
    ...
    py::class_<mmse_interp_differentiator_ff,
        std::shared_ptr<mmse_interp_differentiator_ff>>(m, "mmse_interp_differentiator_ff", D(mmse_interp_differentiator_ff))

        .def(py::init<>(),D(mmse_interp_differentiator_ff,mmse_interp_differentiator_ff,0))
