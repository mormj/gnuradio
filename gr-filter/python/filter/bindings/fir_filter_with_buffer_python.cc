...
void bind_fir_filter_with_buffer(py::module& m)
{
    ...
    py::class_<fir_filter_with_buffer_fff,
        std::shared_ptr<fir_filter_with_buffer_fff>>(m_kernel, "fir_filter_with_buffer_fff", D(kernel,fir_filter_with_buffer_fff))
        ...
        .def("filter",(float (fir_filter_with_buffer_fff::*)(float const *, long unsigned int))&fir_filter_with_buffer_fff::filter,
            py::arg("input"),
            py::arg("dec"),
    ...
    py::class_<fir_filter_with_buffer_ccc,
        std::shared_ptr<fir_filter_with_buffer_ccc>>(m_kernel, "fir_filter_with_buffer_ccc", D(kernel,fir_filter_with_buffer_ccc))
        ...
        .def("filter",(gr_complex (fir_filter_with_buffer_ccc::*)(gr_complex const *, long unsigned int))&fir_filter_with_buffer_ccc::filter,
            py::arg("input"),
            py::arg("dec"),
    ...
    py::class_<fir_filter_with_buffer_ccf,
        std::shared_ptr<fir_filter_with_buffer_ccf>>(m_kernel, "fir_filter_with_buffer_ccf", D(kernel,fir_filter_with_buffer_ccf))
        ...
        .def("filter",(gr_complex (fir_filter_with_buffer_ccf::*)(gr_complex const *, long unsigned int))&fir_filter_with_buffer_ccf::filter,
            py::arg("input"),
            py::arg("dec"),
