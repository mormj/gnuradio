...
void bind_pfb_arb_resampler(py::module& m)
{
    ...
    py::class_<pfb_arb_resampler_ccf,
        std::shared_ptr<pfb_arb_resampler_ccf>>(m_kernel, "pfb_arb_resampler_ccf", D(kernel,pfb_arb_resampler_ccf))
        ...
        .def("taps",&pfb_arb_resampler_ccf::taps,
            D(kernel,pfb_arb_resampler_ccf,taps)
        )
    ...
    py::class_<pfb_arb_resampler_ccc,
        std::shared_ptr<pfb_arb_resampler_ccc>>(m_kernel, "pfb_arb_resampler_ccc", D(kernel,pfb_arb_resampler_ccc))
        ...
        .def("taps",&pfb_arb_resampler_ccc::taps,
            D(kernel,pfb_arb_resampler_ccc,taps)
        )
    ...
    py::class_<pfb_arb_resampler_fff,
        std::shared_ptr<pfb_arb_resampler_fff>>(m_kernel, "pfb_arb_resampler_fff", D(kernel,pfb_arb_resampler_fff))
        ...
        .def("taps",&pfb_arb_resampler_fff::taps,
            D(kernel,pfb_arb_resampler_fff,taps)
        )
