...
void bind_single_pole_iir_filter_ff(py::module& m)
{
    ...
    py::class_<single_pole_iir_filter_ff, gr::sync_block, gr::block, gr::basic_block,
        std::shared_ptr<single_pole_iir_filter_ff>>(m, "single_pole_iir_filter_ff", D(single_pole_iir_filter_ff))
