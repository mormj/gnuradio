...
void bind_pfb_arb_resampler_ccc(py::module& m)
{
    ...
    py::class_<pfb_arb_resampler_ccc, gr::block, gr::basic_block,
        std::shared_ptr<pfb_arb_resampler_ccc>>(m, "pfb_arb_resampler_ccc", D(pfb_arb_resampler_ccc))
