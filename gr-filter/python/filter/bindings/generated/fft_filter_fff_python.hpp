...
#ifndef INCLUDED_GR_FILTER_FFT_FILTER_FFF_PYTHON_HPP
#define INCLUDED_GR_FILTER_FFT_FILTER_FFF_PYTHON_HPP
...
void bind_fft_filter_fff(py::module& m)
{
    ...
    py::class_<fft_filter_fff,gr::sync_decimator,
        ...
        .def("to_basic_block",[](std::shared_ptr<fft_filter_fff> p){
...
#endif /* INCLUDED_GR_FILTER_FFT_FILTER_FFF_PYTHON_HPP */
