...
#ifndef INCLUDED_GR_FILTER_MMSE_RESAMPLER_FF_PYTHON_HPP
#define INCLUDED_GR_FILTER_MMSE_RESAMPLER_FF_PYTHON_HPP
...
void bind_mmse_resampler_ff(py::module& m)
{
    ...
    py::class_<mmse_resampler_ff,gr::block,
        ...
        .def("to_basic_block",[](std::shared_ptr<mmse_resampler_ff> p){
...
#endif /* INCLUDED_GR_FILTER_MMSE_RESAMPLER_FF_PYTHON_HPP */
