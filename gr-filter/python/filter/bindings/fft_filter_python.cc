...
void bind_fft_filter(py::module& m)
{
    ...
    py::class_<fft_filter_fff,
        std::shared_ptr<fft_filter_fff>>(m_kernel, "fft_filter_fff", D(kernel,fft_filter_fff))
        ...
        .def("taps",&fft_filter_fff::taps,
            D(kernel,fft_filter_fff,taps)
        )


        .def("ntaps",&fft_filter_fff::ntaps,
            D(kernel,fft_filter_fff,ntaps)
        )


        .def("nthreads",&fft_filter_fff::nthreads,
            D(kernel,fft_filter_fff,nthreads)
        )
    ...
    py::class_<fft_filter_ccc,
        std::shared_ptr<fft_filter_ccc>>(m_kernel, "fft_filter_ccc", D(kernel,fft_filter_ccc))
        ...
        .def("taps",&fft_filter_ccc::taps,
            D(kernel,fft_filter_ccc,taps)
        )


        .def("ntaps",&fft_filter_ccc::ntaps,
            D(kernel,fft_filter_ccc,ntaps)
        )


        .def("nthreads",&fft_filter_ccc::nthreads,
            D(kernel,fft_filter_ccc,nthreads)
        )
    ...
    py::class_<fft_filter_ccf,
        std::shared_ptr<fft_filter_ccf>>(m_kernel, "fft_filter_ccf", D(kernel,fft_filter_ccf))
        ...
        .def("taps",&fft_filter_ccf::taps,
            D(kernel,fft_filter_ccf,taps)
        )


        .def("ntaps",&fft_filter_ccf::ntaps,
            D(kernel,fft_filter_ccf,ntaps)
        )
        ...
        .def("nthreads",&fft_filter_ccf::nthreads,
            D(kernel,fft_filter_ccf,nthreads)
        )
