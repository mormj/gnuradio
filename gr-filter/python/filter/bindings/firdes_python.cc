...
void bind_firdes(py::module& m)
{
    ...
    ;
        ...
        firdes_class
        .def_static("window",&firdes::window,
            py::arg("type"),
            py::arg("ntaps"),
            py::arg("beta"),
            D(firdes,window)
        ...
        .def_static("low_pass",&firdes::low_pass,
            py::arg("gain"),
        ...
        .def_static("low_pass_2",&firdes::low_pass_2,
            py::arg("gain"),
            py::arg("sampling_freq"),
            py::arg("cutoff_freq"),
            py::arg("transition_width"),
        ...
        .def_static("high_pass",&firdes::high_pass,
            py::arg("gain"),
            py::arg("sampling_freq"),
            py::arg("cutoff_freq"),
            py::arg("transition_width"),
        ...
        .def_static("high_pass_2",&firdes::high_pass_2,
            py::arg("gain"),
            py::arg("sampling_freq"),
            py::arg("cutoff_freq"),
            py::arg("transition_width"),
        ...
        .def_static("band_pass",&firdes::band_pass,
            py::arg("gain"),
            py::arg("sampling_freq"),
        ...
        .def_static("band_pass_2",&firdes::band_pass_2,
            py::arg("gain"),
            py::arg("sampling_freq"),
            py::arg("low_cutoff_freq"),
            py::arg("high_cutoff_freq"),
        ...
        .def_static("complex_band_pass",&firdes::complex_band_pass,
            py::arg("gain"),
            py::arg("sampling_freq"),
            py::arg("low_cutoff_freq"),
            py::arg("high_cutoff_freq"),
        ...
        .def_static("complex_band_pass_2",&firdes::complex_band_pass_2,
            py::arg("gain"),
            py::arg("sampling_freq"),
            py::arg("low_cutoff_freq"),
            py::arg("high_cutoff_freq"),
        ...
        .def_static("band_reject",&firdes::band_reject,
            py::arg("gain"),
            py::arg("sampling_freq"),
            py::arg("low_cutoff_freq"),
            py::arg("high_cutoff_freq"),
        ...
        .def_static("band_reject_2",&firdes::band_reject_2,
            py::arg("gain"),
            py::arg("sampling_freq"),
            py::arg("low_cutoff_freq"),
            py::arg("high_cutoff_freq"),
        ...
        .def_static("hilbert",&firdes::hilbert,
            py::arg("ntaps") = 19,
            py::arg("windowtype") = ::gr::filter::firdes::win_type::WIN_RECTANGULAR,
            py::arg("beta") = 6.7599999999999998,
            D(firdes,hilbert)
        )


        .def_static("root_raised_cosine",&firdes::root_raised_cosine,
            py::arg("gain"),
            py::arg("sampling_freq"),
            py::arg("symbol_rate"),
            py::arg("alpha"),
        ...
        .def_static("gaussian",&firdes::gaussian,
            py::arg("gain"),
            py::arg("spb"),
            py::arg("bt"),
            py::arg("ntaps"),
