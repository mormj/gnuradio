...
void bind_pmt(py::module& m)
{
    ...
    py::class_<pmt_base, std::shared_ptr<pmt_base>>(m, "pmt_base", D(pmt_base))
...
//     py::class_<exception, std::logic_error, std::shared_ptr<exception>>(
//         m, "exception", D(exception))

//         .def(py::init<std::string const&, pmt::pmt_t>(),
//              py::arg("msg"),
//              py::arg("obj"),
//              D(exception, exception, 0))
//         .def(py::init<pmt::exception const&>(),
//              py::arg("arg0"),
//              D(exception, exception, 1))

//         ;


//     py::class_<wrong_type, pmt::exception, std::shared_ptr<wrong_type>>(
//         m, "wrong_type", D(wrong_type))

//         .def(py::init<std::string const&, pmt::pmt_t>(),
//              py::arg("msg"),
//              py::arg("obj"),
//              D(wrong_type, wrong_type, 0))
//         .def(py::init<pmt::wrong_type const&>(),
//              py::arg("arg0"),
//              D(wrong_type, wrong_type, 1))

//         ;


//     py::class_<out_of_range, pmt::exception, std::shared_ptr<out_of_range>>(
//         m, "out_of_range", D(out_of_range))

//         .def(py::init<std::string const&, pmt::pmt_t>(),
//              py::arg("msg"),
//              py::arg("obj"),
//              D(out_of_range, out_of_range, 0))
//         .def(py::init<pmt::out_of_range const&>(),
//              py::arg("arg0"),
//              D(out_of_range, out_of_range, 1))

//         ;


//     py::class_<notimplemented, pmt::exception, std::shared_ptr<notimplemented>>(
//         m, "notimplemented", D(notimplemented))

//         .def(py::init<std::string const&, pmt::pmt_t>(),
//              py::arg("msg"),
//              py::arg("obj"),
//              D(notimplemented, notimplemented, 0))
//         .def(py::init<pmt::notimplemented const&>(),
//              py::arg("arg0"),
//              D(notimplemented, notimplemented, 1))

//         ;


    py::class_<comparator, std::shared_ptr<comparator>>(m, "comparator", D(comparator))

        .def(py::init<>(), D(comparator, comparator, 0))
        .def(py::init<pmt::comparator const&>(),
             py::arg("arg0"),
             D(comparator, comparator, 1))
    ...
    m.def("init_s8vector",
          (pmt::pmt_t(*)(
              size_t, std::vector<signed char, std::allocator<signed char>> const&)) &
              ::pmt::init_s8vector,
          py::arg("k"),
          py::arg("data"),
          D(init_s8vector, 1));
    ...
    m.def("c64vector_elements",
          (std::vector<std::complex<double>, std::allocator<std::complex<double>>> const (
              *)(pmt::pmt_t)) &
              ::pmt::c64vector_elements,
          py::arg("v"),
...
//     m.def("pmt_u8vector_elements",
//           &::pmt::pmt_u8vector_elements,
//           py::arg("v"),
//           D(pmt_u8vector_elements));


//     m.def("pmt_s8vector_elements",
//           &::pmt::pmt_s8vector_elements,
//           py::arg("v"),
//           D(pmt_s8vector_elements));


//     m.def("pmt_u16vector_elements",
//           &::pmt::pmt_u16vector_elements,
//           py::arg("v"),
//           D(pmt_u16vector_elements));


//     m.def("pmt_s16vector_elements",
//           &::pmt::pmt_s16vector_elements,
//           py::arg("v"),
//           D(pmt_s16vector_elements));


//     m.def("pmt_u32vector_elements",
//           &::pmt::pmt_u32vector_elements,
//           py::arg("v"),
//           D(pmt_u32vector_elements));


//     m.def("pmt_s32vector_elements",
//           &::pmt::pmt_s32vector_elements,
//           py::arg("v"),
//           D(pmt_s32vector_elements));


//     m.def("pmt_u64vector_elements",
//           &::pmt::pmt_u64vector_elements,
//           py::arg("v"),
//           D(pmt_u64vector_elements));


//     m.def("pmt_s64vector_elements",
//           &::pmt::pmt_s64vector_elements,
//           py::arg("v"),
//           D(pmt_s64vector_elements));


//     m.def("pmt_f32vector_elements",
//           &::pmt::pmt_f32vector_elements,
//           py::arg("v"),
//           D(pmt_f32vector_elements));


//     m.def("pmt_f64vector_elements",
//           &::pmt::pmt_f64vector_elements,
//           py::arg("v"),
//           D(pmt_f64vector_elements));


//     m.def("pmt_c32vector_elements",
//           &::pmt::pmt_c32vector_elements,
//           py::arg("v"),
//           D(pmt_c32vector_elements));


//     m.def("pmt_c64vector_elements",
//           &::pmt::pmt_c64vector_elements,
//           py::arg("v"),
//           D(pmt_c64vector_elements));
...
//     m.def("is_msg_accepter", &::pmt::is_msg_accepter, py::arg("obj"), D(is_msg_accepter));


//     m.def("make_msg_accepter",
//           &::pmt::make_msg_accepter,
//           py::arg("ma"),
//           D(make_msg_accepter));


//     m.def("msg_accepter_ref",
...
//           D(msg_accepter_ref));
    ...
    m.def("serialize_str", &::pmt::serialize_str, py::arg("obj"), D(serialize_str));
