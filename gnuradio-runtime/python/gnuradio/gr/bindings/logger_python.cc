...
void bind_logger(py::module& m)
{
    ...
    py::class_<logger,
        std::shared_ptr<logger>>(m, "logger", D(logger))
        ...
        .def("add_rollingfile_appender",&logger::add_rollingfile_appender,
            ...
            py::arg("mode"),
            py::arg("pattern"),
            D(logger,add_rollingfile_appender)
        )

        ;


    py::class_<logger_config,
        std::shared_ptr<logger_config>>(m, "logger_config", D(logger_config))



        .def_static("get_filename",&logger_config::get_filename,
            D(logger_config,get_filename)
        )


        .def_static("get_watch_period",&logger_config::get_watch_period,
            D(logger_config,get_watch_period)
        )


        .def_static("load_config",&logger_config::load_config,
            py::arg("filename"),
            py::arg("watch_period") = 0,
            D(logger_config,load_config)
        )


        .def_static("stop_watch",&logger_config::stop_watch,
            D(logger_config,stop_watch)
        )


        .def_static("reset_config",&logger_config::reset_config,
            D(logger_config,reset_config)
        )
    ...
    // );
        ...
        m.def("logger_load_config",&::gr::logger_load_config,
            ...
            D(logger_load_config)
        );


        m.def("logger_reset_config",&::gr::logger_reset_config,
            D(logger_reset_config)
        );


        m.def("logger_set_level",(void (::*)(gr::logger_ptr, std::string const &))&::gr::logger_set_level,
            py::arg("logger"),
            py::arg("level"),
            D(logger_set_level,0)
        );


        m.def("logger_set_level",(void (::*)(gr::logger_ptr, log4cpp::Priority::Value))&::gr::logger_set_level,
            py::arg("logger"),
            py::arg("level"),
            D(logger_set_level,1)
        );


        m.def("logger_get_level",(void (::*)(gr::logger_ptr, std::string &))&::gr::logger_get_level,
            py::arg("logger"),
            py::arg("level"),
            D(logger_get_level,0)
        );

    );
    // m.def("logger_get_level",(void (*)(gr::logger_ptr, log4cpp::Priority::Value &))&gr::logger_get_level,
    //     py::arg("logger"), 
    //     py::arg("level") 
    // );
    ...
    // ); // Not Implemented
        ...
        m.def("logger_add_rollingfile_appender",&::gr::logger_add_rollingfile_appender,
            ...
            py::arg("mode"),
            py::arg("pattern"),
            D(logger_add_rollingfile_appender)
        );


        m.def("logger_get_logger_names",&::gr::logger_get_logger_names,
            D(logger_get_logger_names)
        );
