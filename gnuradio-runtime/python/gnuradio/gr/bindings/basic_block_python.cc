...
void bind_basic_block(py::module& m)
{
    ...
    py::class_<basic_block, gr::msg_accepter,
        std::shared_ptr<basic_block>>(m, "basic_block", D(basic_block))
        ...
        .def("unique_id",&basic_block::unique_id,
            D(basic_block,unique_id)
        )


        .def("symbolic_id",&basic_block::symbolic_id,
            D(basic_block,symbolic_id)
        )
        ...
        .def("symbol_name",&basic_block::symbol_name,
            D(basic_block,symbol_name)
        )


        .def("identifier",&basic_block::identifier,
            D(basic_block,identifier)
        )
