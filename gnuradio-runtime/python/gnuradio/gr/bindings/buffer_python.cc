...
void bind_buffer(py::module& m)
{
    ...
    py::class_<buffer,
        ...
        .def("get_tags_begin",&buffer::get_tags_begin,
            D(buffer,get_tags_begin)
        )


        .def("get_tags_end",&buffer::get_tags_end,
            D(buffer,get_tags_end)
        )
