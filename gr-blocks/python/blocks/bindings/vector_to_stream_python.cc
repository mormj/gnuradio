...
void bind_vector_to_stream(py::module& m)
{
    ...
    py::class_<vector_to_stream, gr::sync_interpolator, gr::sync_block, gr::block, gr::basic_block,
        std::shared_ptr<vector_to_stream>>(m, "vector_to_stream", D(vector_to_stream))
