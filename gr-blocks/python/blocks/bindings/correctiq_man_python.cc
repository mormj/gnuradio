...
void bind_correctiq_man(py::module& m)
{
    ...
    py::class_<correctiq_man, gr::sync_block, gr::block, gr::basic_block,
        ...
        .def("get_real",&correctiq_man::get_real,
            D(correctiq_man,get_real)
        )


        .def("get_imag",&correctiq_man::get_imag,
            D(correctiq_man,get_imag)
        )


        .def("set_real",&correctiq_man::set_real,
            py::arg("newValue"),
            D(correctiq_man,set_real)
        )


        .def("set_imag",&correctiq_man::set_imag,
            py::arg("newValue"),
