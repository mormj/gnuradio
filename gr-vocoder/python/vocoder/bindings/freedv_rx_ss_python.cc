...
void bind_freedv_rx_ss(py::module& m)
{
    ...
    py::class_<freedv_rx_ss, gr::block, gr::basic_block,
        std::shared_ptr<freedv_rx_ss>>(m, "freedv_rx_ss", D(freedv_rx_ss))
        ...
        .def("set_squelch_thresh",&freedv_rx_ss::set_squelch_thresh,
            py::arg("squelch_thresh"),
            D(freedv_rx_ss,set_squelch_thresh)
        )


        .def("squelch_thresh",&freedv_rx_ss::squelch_thresh,
