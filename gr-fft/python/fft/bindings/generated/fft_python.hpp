...
#ifndef INCLUDED_GR_FFT_FFT_PYTHON_HPP
#define INCLUDED_GR_FFT_FFT_PYTHON_HPP
...
void bind_fft(py::module& m)
{
    ...
    py::class_<fft_complex, std::shared_ptr<fft_complex>>(m, "fft_complex")
        ...
        .def("set_nthreads", &fft_complex::set_nthreads, py::arg("n"))
        .def("nthreads", &fft_complex::nthreads)
        .def("execute", &fft_complex::execute)
        ;

    py::class_<fft_real_fwd, std::shared_ptr<fft_real_fwd>>(m, "fft_real_fwd")

        .def(py::init<int, int>(), py::arg("fft_size"), py::arg("nthreads") = 1)
        ...
        .def("set_nthreads", &fft_real_fwd::set_nthreads, py::arg("n"))
        .def("nthreads", &fft_real_fwd::nthreads)
        .def("execute", &fft_real_fwd::execute)
        ;

    py::class_<fft_real_rev, std::shared_ptr<fft_real_rev>>(m, "fft_real_rev")
        ...
        .def("set_nthreads", &fft_real_rev::set_nthreads, py::arg("n"))
        .def("nthreads", &fft_real_rev::nthreads)
        .def("execute", &fft_real_rev::execute)
        ;

    m.def("malloc_complex", &gr::fft::malloc_complex, py::arg("size"));
    m.def("free", &gr::fft::free, py::arg("b"));
}

#endif /* INCLUDED_GR_FFT_FFT_PYTHON_HPP */
