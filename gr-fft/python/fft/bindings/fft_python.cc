...
void bind_fft(py::module& m)
{
    ...
    py::class_<planner,
        std::shared_ptr<planner>>(m, "planner", D(planner))
        ...
        .def_static("mutex",&planner::mutex,
            D(planner,mutex)
        )
    ...
    py::class_<fft_complex,
        std::shared_ptr<fft_complex>>(m, "fft_complex", D(fft_complex))
        ...
        .def("nthreads",&fft_complex::nthreads,
            D(fft_complex,nthreads)
        )


        .def("execute",&fft_complex::execute,
            D(fft_complex,execute)
        )
    ...
    py::class_<fft_real_fwd,
        std::shared_ptr<fft_real_fwd>>(m, "fft_real_fwd", D(fft_real_fwd))
        ...
        .def("nthreads",&fft_real_fwd::nthreads,
            D(fft_real_fwd,nthreads)
        )


        .def("execute",&fft_real_fwd::execute,
            D(fft_real_fwd,execute)
        )
    ...
    py::class_<fft_real_rev,
        std::shared_ptr<fft_real_rev>>(m, "fft_real_rev", D(fft_real_rev))
        ...
        .def("get_inbuf",&fft_real_rev::get_inbuf,
            D(fft_real_rev,get_inbuf)
        )


        .def("get_outbuf",&fft_real_rev::get_outbuf,
            D(fft_real_rev,get_outbuf)
        )
        ...
        .def("nthreads",&fft_real_rev::nthreads,
            D(fft_real_rev,nthreads)
        )


        .def("execute",&fft_real_rev::execute,
            D(fft_real_rev,execute)
        )
